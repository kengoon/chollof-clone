...
# (str) Package name
package.name = chollof

# (str) Package domain (needed for android/ios packaging)
package.domain = com.chopsome
...
requirements = python3==3.11.11,hostpython3==3.11.11,kivy,https://github.com/kivymd/KivyMD/archive/master.zip,asynckivy,materialyoucolor,
    exceptiongroup,asyncgui,sjfirebase,sdl2==2.30.11,sdl2_mixer==2.8.0,sdl2_ttf==2.24.0,sdl2_image==2.8.4,libffi==v3.4.6
...
android.presplash_color = #FFF9EF
